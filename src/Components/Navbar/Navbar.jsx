    ...
    const loadUser = () => {
      ...
      if (storedUser && token) {
        try {
          ...
          // Optional: manually enforce 1-day expiration from token issuance
          const issuedAt = decodedToken.iat; // token issued at (seconds)
          const oneDayInSeconds = 24 * 60 * 60; // 86400 seconds

          if (decodedToken.exp < currentTime || currentTime > issuedAt + oneDayInSeconds) {
            handleLogout();
            return;
          }
